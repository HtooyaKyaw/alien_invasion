...
class AlienInvasion:
	...
	def _check_events(self):
		"""respind to keypresses and mouse events"""
		#wait for keyboard and mouse event
	...
	def _check_bullet_aliens_collisions(self):
		...
		# if so delete the alien and bullet
	...
	def create_fleet(self):
		"""create the aliens and a number of aliens in a row"""
		#spacing between each alien is equal one alien width
		...
		#determine the number of aliens fit on the screen
		ship_height = self.ship.rect.height
		available_space_y = (self.settings.screen_height - (3 * alien_height) - ship_height)
		number_rows = available_space_y // (2 * alien_height)

		#create a full fleet of alien
		for each_row in range(number_rows):
	...
	def _create_alien(self, each_alien, each_row):
		...
		alien.rect.y = alien.rect.height + 2 * alien.rect.height * each_row
	...
	def _update_aliens(self):
		...
		#look for aliens and ship colliding
		if pygame.sprite.spritecollideany(self.ship, self.aliens):
			self.ship_hit()
		#look for aliens hitting bottom of the ship
